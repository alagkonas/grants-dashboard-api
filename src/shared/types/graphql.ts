...
export interface IQuery {
    getMatches(filter?: Nullable<MatchFilter>, sort?: Nullable<MatchSort[]>, limit?: Nullable<number>, offset?: Nullable<number>): Match[] | Promise<Match[]>;
    getApplications(filter?: Nullable<ApplicationFilter>, sort?: Nullable<ApplicationSort[]>, limit?: Nullable<number>, offset?: Nullable<number>): Application[] | Promise<Application[]>;
}

export interface IMutation {
    createApplication(matchId: string): Application | Promise<Application>;
    updateApplicationStatus(applicationId: string, status: ApplicationStatus): Application | Promise<Application>;
}
